...
<%
ArrayList<Local> lista = (ArrayList<Local>) request.getAttribute("locais"); // recebe o objeto lista
...
<title>Administrador | Locais</title>
					...
					<main class="container_noticia_principal sport_page">
						<div class="container_liveTable">
							<div class="container_Table_Player">
								<p>
									<a href="adicionarLocal.html" class="BotaoNovo">Novo Local</a>
								</p>
...
<%-- <div id="interface">
	...
	<div>
		<p>
			<a href="adicionarLocal.html" class="BotaoNovo">Adicionar Local</a>
		</p>
		<table>
			<thead>
				<tr>
