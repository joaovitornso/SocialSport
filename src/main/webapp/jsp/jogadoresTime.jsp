								...
								<div class="container_tabela">
									...
									<table>
										...
										<tbody>
											...
											%>
											<tr>
												<td><%=time.getJogadores().get(i).getIdjogador()%></td>
												<td><%=time.getJogadores().get(i).getNome()%></td>
												<td><%=time.getJogadores().get(i).getIdade()%></td>
												<td><%=time.getJogadores().get(i).getNmrCamisa()%></td>
												<td><%=time.getJogadores().get(i).getNmrPunicoes()%></td>
												<td><a
													href="select?idjogador=<%=time.getJogadores().get(i).getIdjogador()%>"
													class="BotaoEditar">Editar</a> <a
													href="expulsarJogador?idJogador=<%=time.getJogadores().get(i).getIdjogador()%>"
													class="BotaoDeletar">ExpulsarJogador</a></td>
											</tr>
											<%
											}
											%>
...
<%-- <h3>Quantidade Atual de Jogadores: <%=time.getQntJogadores()%></h3> --%>
<%-- <table id="tabela">
	<thead>
		<tr>
			<th>Id</th>
