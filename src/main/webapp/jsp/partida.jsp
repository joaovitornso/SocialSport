...
<%
ArrayList<Partida> lista = (ArrayList<Partida>) request.getAttribute("partidas"); // recebe o objeto lista
...
<title>Social Sports | Partidas</title>
					...
					<main class="container_noticia_principal sport_page">
						<div class="container_liveTable">
							<div class="container_Table_Player">
								<p>
									<a href="novaPartida.html" class="BotaoNovo">Adicionar
										Partida</a>
								</p>
								<div class="container_tabela">
									<table>
										...
										<tbody>
											...
											%>
											<tr>
												<td><%=lista.get(i).getIdPartida()%></td>
												<td><%=lista.get(i).getData()%></td>
												<td><%=lista.get(i).getHorario()%></td>
												<td><a
													href="selectPartida?idPartida=<%=lista.get(i).getIdPartida()%>"
													class="BotaoEditar">Editar</a></td>
												<td><a
													href="javascript: confirmarPartida(<%=lista.get(i).getIdPartida()%>)"
													class="BotaoDeletar">Deletar</a></td>
												<td><a
													href="setarEsporte?idPartida=<%=lista.get(i).getIdPartida()%>"
