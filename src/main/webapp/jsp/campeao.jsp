...
<link rel="stylesheet" href="formNovo.css">
...
.input-box a:focus, .input-box a:valid {
	border-color: #9b59b6;
}
</style>
</head>
	...
	<div class="main_header">
		<div>
			<div class="center_div">
				<p>
					PARABÉNS! O NOVO VENCEDOR DO CAMPEONATO IFNATO! <br>
					<%=time.getNome()%>
					<br> <img class="medal" src="imagens/icons/gold-medal.png">
				</p>
